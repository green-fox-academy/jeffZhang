-- MySQL vscode extension is used to connect to mysql, sql file can be written and executed here; before executing the following sql, connection should be established first.
